...
func (in *LinodeClusterSpec) DeepCopyInto(out *LinodeClusterSpec) {
	*out = *in
	...
	if in.ControlPlaneFirewallRefs != nil {
		in, out := &in.ControlPlaneFirewallRefs, &out.ControlPlaneFirewallRefs
	...
	if in.WorkerFirewallRefs != nil {
		in, out := &in.WorkerFirewallRefs, &out.WorkerFirewallRefs
		*out = make([]*v1.ObjectReference, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
