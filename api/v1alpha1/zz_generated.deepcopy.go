...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LinodeObjStorageBucket) DeepCopyInto(out *LinodeObjStorageBucket) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LinodeObjStorageBucket.
func (in *LinodeObjStorageBucket) DeepCopy() *LinodeObjStorageBucket {
	if in == nil {
		return nil
	}
	out := new(LinodeObjStorageBucket)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LinodeObjectStorageKeySpec) DeepCopyInto(out *LinodeObjectStorageKeySpec) {
	*out = *in
	if in.Buckets != nil {
		...
		*out = make([]LinodeObjStorageBucket, len(*in))
		copy(*out, *in)
	}
	if in.CredentialsRef != nil {
		in, out := &in.CredentialsRef, &out.CredentialsRef
