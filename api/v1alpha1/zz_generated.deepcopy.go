...
func (in *FirewallSpec) DeepCopyInto(out *FirewallSpec) {
	*out = *in
	if in.AllowedIPV4Addresses != nil {
		in, out := &in.AllowedIPV4Addresses, &out.AllowedIPV4Addresses
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AllowedIPV6Addresses != nil {
		in, out := &in.AllowedIPV6Addresses, &out.AllowedIPV6Addresses
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *LinodeClusterSpec) DeepCopyInto(out *LinodeClusterSpec) {
	*out = *in
	...
	in.ControlPlaneFirewall.DeepCopyInto(&out.ControlPlaneFirewall)
	if in.ControlPlaneFirewallRef != nil {
		in, out := &in.ControlPlaneFirewallRef, &out.ControlPlaneFirewallRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
}
