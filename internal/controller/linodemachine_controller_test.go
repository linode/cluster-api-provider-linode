	...
	Context("creates a instance with disks", func() {
		It("in a single call when disks aren't delayed", func(ctx SpecContext) {
			...
			linodeMachine.Spec.DataDisks = &infrav1alpha2.InstanceDisks{
				...
				SDC: ptr.To(infrav1alpha2.InstanceDisk{Label: "disk2", Size: resource.MustParse("128Mi")}),
				SDD: ptr.To(infrav1alpha2.InstanceDisk{Label: "disk3", Size: resource.MustParse("128Mi")}),
				SDE: ptr.To(infrav1alpha2.InstanceDisk{Label: "disk4", Size: resource.MustParse("128Mi")}),
				SDF: ptr.To(infrav1alpha2.InstanceDisk{Label: "disk5", Size: resource.MustParse("128Mi")}),
				SDG: ptr.To(infrav1alpha2.InstanceDisk{Label: "disk6", Size: resource.MustParse("128Mi")}),
				SDH: ptr.To(infrav1alpha2.InstanceDisk{Label: "disk7", Size: resource.MustParse("128Mi")}),
			}
